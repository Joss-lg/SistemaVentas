...
@section('content')
<div class="max-w-6xl mx-auto space-y-8 p-4 md:p-0 transition-colors duration-300">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div class="bg-white dark:bg-[#0d0d0d] border {{ $corte->difference < 0 ? 'border-red-500/30' : 'border-emerald-500/30' }} p-5 rounded-2xl shadow-xl">
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-zinc-100 dark:divide-white/5">
                    ...
                    <tr class="hover:bg-zinc-50 dark:hover:bg-white/5 transition-colors">
                        ...
                        <td class="p-4 pr-6 text-right font-black italic text-blue-600 dark:text-blue-500 tabular-nums">-${{ number_format($c->costo_total, 2) }}</td>
                    </tr>
                    @empty
