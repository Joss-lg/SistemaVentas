<div x-show="openEdit" x-cloak class="fixed inset-0 z-[1000] flex items-center justify-center p-4 bg-zinc-950/80 backdrop-blur-sm">
    <div class="bg-white dark:bg-[#0d0d0d] w-full max-w-md rounded-3xl p-6 md:p-8 shadow-2xl border border-zinc-200 dark:border-white/10" @click.away="openEdit = false">
